...
#
# This script can be used to uninstall the IBM Cloud Pak for Watson AIOps AI Manager v3.5 product and
...
. ./tools/99_uninstall/3.6/uninstall-cp4waiops-helper.sh
. ./tools/99_uninstall/3.6/uninstall-cp4waiops-resource-groups.props
...
if [[ $SKIP_CONFIRM != "true" ]]; then
  log $INFO "\033[0;33mUninstall v1.0 for AIOPs v3.5\033[0m"
  log $INFO
  log $INFO "This script will uninstall IBM Cloud Pak for AIOps version 3.5. Please ensure you have deleted any CRs you created before running this script."
  log $INFO ""
  log $INFO "##### IMPORTANT ######"
  log $INFO ""
