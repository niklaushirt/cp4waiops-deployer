...
# export PROVIDER_NAME='PUSHOVER'
# export PROVIDER_URL='https://api.pushover.net/1/messages.json'
# export PROVIDER_USER='uqgyUxxxxxxwpTCzv'
# export PROVIDER_TOKEN='a1f4fzxxxxxepo6arb8'

# export PROVIDER_NAME='PAGERDUTY'
# export PROVIDER_URL='https://events.pagerduty.com/v2/enqueue'
# export PROVIDER_USER='NOT NEEDED'
# export PROVIDER_TOKEN='70646bcxxxxxxxxxxxxxa913dc5'


export PROVIDER_NAME='DISCORD'
export PROVIDER_URL='https://discord.com/api/webhooks/10602504zzzzzzzzzIFN0AedFzNJKnA'
export PROVIDER_USER='NOT NEEDED'
