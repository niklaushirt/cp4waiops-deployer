...
def sendDiscord(currentStories, storyCount, DATALAYER_USER, DATALAYER_PWD, DATALAYER_ROUTE):
    print('')
    print ('        ---------------------------------------------------------------------------------------------')
    ...
    print ('           🔐 Datalayer api_url:      '+api_url)

    similar_incident=''
    resolution=''
    alertsJSONString=''
    debug(currentStories)
    debug ('        ---------------------------------------------------------------------------------------------')

    debug(currentStories['stories'][storyCount-1])
    ...
    alertIds=currentStories['stories'][storyCount-1]['alertIds']
...
def sendMail(currentStories, storyCount, DATALAYER_USER, DATALAYER_PWD, DATALAYER_ROUTE):
    print('')
    print('')
    print ('        ---------------------------------------------------------------------------------------------')
    print ('         ✉️ Send Mail')
