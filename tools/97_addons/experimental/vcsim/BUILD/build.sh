...
# Create the Image
docker buildx build --platform linux/amd64 -t quay.io/niklaushirt/vsphere-simulator:$CONT_VERSION --load .
docker push quay.io/niklaushirt/vsphere-simulator:$CONT_VERSION
...
docker build -t vsphere-simulator:$CONT_VERSION .
