...
"dSwitch-5-vm-network-port-1,TransactionsPerSecond,TransactionsPerSecond,0,1"
"dcwest1-switch025,TransactionsPerSecond,TransactionsPerSecond,60,30"
"catalogue-db-predictive,TransactionsPerSecond,TransactionsPerSecond,0,1"
"catalogue-db-predictive,Latency,Latency,1000,100"
"catalogue-predictive,TransactionsPerSecond,TransactionsPerSecond,160,40"
"catalogue-predictive,Latency,Latency,2,1"
)
