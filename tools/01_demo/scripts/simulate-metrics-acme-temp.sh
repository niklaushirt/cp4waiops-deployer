...
"DCWest1-Rack046-DELL3765,CPU1Temperature,System,ITERATIONS,90"
)


# Number of Global Iterations
export MAX_ITERATIONS=10
export METRICS_SKEW="-25M"
...
export TIME_INCREMENT_SECONDS="120" 
...
echo "   "
echo "   ----------------------------------------------------------------------------------------------------------------------------------------"
echo "     🚀  Inject Synthetic Metrics for Fan Tempurature Anomaly generation"
echo "   ----------------------------------------------------------------------------------------------------------------------------------------"
...
do
      ...
      do
            ...
            echo "        ♻️  ITERATION: $ITERATIONS-$BUNDLE_ITERATIONS     at "$act_timestamp_readable"   -     Seconds skew "$ADD_SECONDS"   - "$MY_TIMESTAMP"  -  CURRENT_VALUE:"$CURRENT_VALUE
            #echo ""
            ...
            do
                  ...
                  if [[ $MY_FIX_VALUE == "ITERATIONS" ]]; then
                        MY_FIX_VALUE=$(( MY_VARIATION+2*ITERATIONS ))
