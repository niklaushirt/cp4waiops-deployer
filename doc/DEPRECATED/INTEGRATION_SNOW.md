...
4. Save	
5. Set the password to Defined at installation
...
4. Enter the following integration information as shown below:
  ![servicenow-form](./pics/servicenow-form.png)
    ...
    * Password: Here this would be `Defined at installation` (if you followed the steps above - the ServiceNow Events user password).
